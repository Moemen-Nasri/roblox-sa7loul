...
local function ToggleMicBypass()
    ...
    if audioIn then
        audioIn.Muted = not audioIn.Muted
        notif("Mic Bypass: " .. (audioIn.Muted and "Enabled" or "Disabled"), 2)
    else
...
function UpdateRightContent()
    ...
    elseif CurrentTab == "  Fun" then
        ...
        -- Cesar/Sechoir Spawn Button
        CreateButton(cuffSection, "🚀 Spawn All Cesar/Sechoir", function()
